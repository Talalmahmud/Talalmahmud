...
jobs:
  update-stats:
    ...
    steps:
      ...
      - name: Get Organization Repo Stats
        uses: keshavsingh/gh-insights@main
        with:
      ...
      - name: Update README
        run: |
          echo "## Organization Commit Stats" >> README.md
          echo "![](https://github-readme-stats.vercel.app/api?username=YourOrganizationName&theme=radical&hide_border=true)" >> README.md
      - name: Commit changes
        run: |
          git config --global user.name 'github-actions'
          git config --global user.email 'github-actions@github.com'
          git add README.md
          git commit -m 'Update organization commit stats'
          git push
